<p align="center">
    <a target="_blank" href="https://github.com/xia-zhou/Cydeer-Free-Mybatis-Tool" style="text-decoration:none;">
		<img src="https://s4.ax1x.com/2022/02/16/HfOyi4.png" >
	</a>
</p>

<p align="center">
    <a target="_blank" href="https://plugins.jetbrains.com/plugin/24106-cydeer-free-mybatis-tool" style="text-decoration:none;">
	...
	<a target="_blank" href="https://github.com/xia-zhou/Cydeer-Free-Mybatis-Tool/blob/main/LICENSE" style="text-decoration:none;">
        <img src="https://img.shields.io/badge/license-Apache--2.0-blue.svg" />
	</a>
</p>

# Cydeer Free MyBatis Tool

## [Plugin homepage](https://plugins.jetbrains.com/plugin/24106-cydeer-free-mybatis-tool)

<!-- Plugin description -->
**Cydeer Free MyBatis Tool** is a plugin that enhances idea support for mybatis.
...
**Cydeer Free MyBatis Tool** 是一款增强idea对mybatis支持的插件。
#### 主要功能如下：
* 生成mapper xml文件
...
* Open the **Mapper** interface file and click the arrow on the left to jump to the **xml** file.
