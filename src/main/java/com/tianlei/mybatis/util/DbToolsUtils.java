...
public class DbToolsUtils {
    ...
    public static IntellijColumnInfo convertColumnToIntellijColumnInfo(DasColumn column, String databaseType) {
        ...
        columnInfo.setDataType(convertTypeNameToJdbcType(column.getDasType().toDataType().typeName,
                                                         column.getDasType().toDataType().size, databaseType));
        ...
        columnInfo.setSize(column.getDasType().toDataType().getLength());
        columnInfo.setDecimalDigits(column.getDasType().toDataType().getScale());
